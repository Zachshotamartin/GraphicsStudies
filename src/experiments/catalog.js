...
export const experiments = [
  {
    ...
    controls: [
      range("count", "Dots", 200, 5000, 100, 1800),
      range("iterations", "Relaxation passes", 1, 30, 1, 16),
      range("seed", "Seed", 1, 100, 1, 42),
    ],
    hint: "Run the relaxation, then export the dots as a resolution-independent SVG.",
    method: [
      "Sample an initial point distribution according to image darkness.",
      "Assign weighted image samples to their nearest point, forming Voronoi cells.",
      "Move each point toward its cell’s weighted centroid and repeat.",
    ],
    limit:
  ...
  },
  {
    ...
    hint: "The sample cone is masked already. Add to the coral mask, or clear it and paint another region. Keyboard: focus the source and use arrows to move and paint.",
    method: [
  ...
  },
  {
    ...
    controls: [
      ...
      range("coherence", "Spatial coherence", 0, 2, 0.1, 0.5),
      range("candidates", "Search candidates", 16, 128, 16, 64),
      range("seed", "Seed", 1, 100, 1, 42),
    ],
    hint: "A and A′ must be an aligned pair. The sample A′ was computed by the painterly renderer; B is a separate photograph.",
    method: [
